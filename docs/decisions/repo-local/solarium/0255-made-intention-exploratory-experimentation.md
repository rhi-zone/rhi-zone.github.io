...
**Context.** Positioning solarium's practice relative to 'experimental' work: clarifying whether pieces are open-ended explorations or deliberately conceived and finished artifacts.

**Decision.** Pieces are not experimental in the 'let's see what happens' sense; they are made with intention and finished with intention.
