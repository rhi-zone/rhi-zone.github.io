...
**Context.** Deciding what role the hosting site (para.garden/solarium/) plays relative to the works it presents: whether it imposes a unifying frame/aesthetic or stays out of the way.

**Decision.** The site is a neutral host, not an opinionated container — it presents works without imposing a unifying frame on them.
