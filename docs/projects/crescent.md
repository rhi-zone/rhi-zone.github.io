...
Type inference engine with structural operator dispatch, discriminated unions, generics, and metatable slot handling. Test infrastructure in place. Active development on type system features.
:::
