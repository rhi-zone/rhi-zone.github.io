...
::: info Status: Growing ◔
Signal detection pipeline with chi-square uniformity, alignment map, TLV sequence, padding run, and ngram frequency detectors. Core architecture in place, expanding signal coverage.
:::
