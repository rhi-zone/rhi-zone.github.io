...
v0.2 released. Multiple protocol implementations (HTTP, CLI, MCP, WebSocket, JSON-RPC, GraphQL, gRPC schema generation), with a test suite. HTTP/CLI/MCP stable; remaining: middleware, streaming, client generation.
:::
