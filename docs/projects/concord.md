...
::: info Status: Growing ◔
Working MVP (concord-core, concord-codegen) with functional OpenAPI → Rust codegen, dogfood tested on petstore. Clear architecture and documented design decisions. Remaining: inline/anonymous enums, integer enums, multi-language codegen.
:::
