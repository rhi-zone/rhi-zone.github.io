...
- **[Antihero slices](#under-served-slices-of-the-antihero-space-character-archetypes)**: a forest cousin who is *actually* cruel, lazy, vain — mundane-flaw register, but the flatlanders read every encounter through the harpy-as-monster filter. The character's interior is ordinary; the projection makes them mythical.
