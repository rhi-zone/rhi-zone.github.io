...
- [x] **Why software is shaped wrong** — exoplace/github-io session (Jan 29, session 444dae7b). VERY rich — 7 sub-topics: objects-not-documents, bridge problems, incumbents aren't competent, two tracks of programming (lost word "hacker"), state-not-architecture, 8-item forcing function, dopamine arbitrage. "Objects not documents" written as `why-is-everything-a-document.md`. "Two tracks" written as `there-used-to-be-two-kinds-of-programmer.md`. "Dopamine arbitrage" written as `what-if-your-brain-isnt-broken.md`. All sub-topics covered. Grep: `notes`, `freeform`, `spreadsheet`, `paper`, `objects`, `documents`, `hacker`
- [x] **Can programs write programs?** — Written as `can-programs-write-programs.md` on pteraworld. Fractal code structure, layers of abstraction, meaning doesn't recurse, trust the common case not the edge cases.
- [x] **What counts as vibe coding?** — Spec gaming insight written as standalone `can-you-tell-when-its-wrong.md`. Covers specification gaming, hallucination as feedback loop, epistemic limits of evaluation. Distinct from overlap with existing essays.
- [x] **The NIH instinct** — Written as `why-cant-you-just-use-what-exists.md`. Distinct from reinvention essay: covers friction with encoded assumptions, understanding that doesn't transfer through docs, the identity dimension.
- [x] **Why nothing feels special / why did things stop being personal?** — Written as companion essay `why-did-things-stop-being-personal.md`. Covers personal web economics, GeoCities grief, Tumblr paradox, platform convergence, nostalgia for something you never had. Cross-referenced from `why-is-nothing-special-anymore.md`.
- [x] **Architect vs inhabit** — Merged into `when-should-you-stop-building.md`. Construction site vs building, the two modes, the visceral test, perfectionism as avoidance of judgment. Extends "why do i build tools?" without duplicating it.
- [x] **Where does meaning live? / Why doesn't the engine know what anything means?** — Written as `where-does-meaning-live.md`. Covers abstractions shouldn't encode specifics, meaning as emergent from structure + use, the temptation to specialize, identity as structure without encoded specifics.
- [x] **When should you stop building and start using?** — Written as `when-should-you-stop-building.md`, merged with architect-vs-inhabit thread. Construction site metaphor, visceral test, two modes, signs to stop.
