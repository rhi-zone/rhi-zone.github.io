...
- [x] **Why software is shaped wrong** — exoplace/github-io session (Jan 29, session 444dae7b). VERY rich — 7 sub-topics: objects-not-documents, bridge problems, incumbents aren't competent, two tracks of programming (lost word "hacker"), state-not-architecture, 8-item forcing function, dopamine arbitrage. "Objects not documents" written as `why-is-everything-a-document.md`. Remaining sub-topics ("two tracks", "dopamine arbitrage") still available for future essays. Grep: `notes`, `freeform`, `spreadsheet`, `paper`, `objects`, `documents`, `hacker`
